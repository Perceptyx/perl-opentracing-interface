...
An object that does L<OpenTracing::Interface::ScopeManager>
...
An object that does L<OpenTracing::Interface::Span> or C<undef> if there is no
active C<Scope>.
...
an C<ArrayRef> of L<OpenTracing::Interface::Reference>
...
An object that implements the L<OpenTracing::Interface::Scope> interface.

=head3 Note

C<child_of> and C<references> should be mutual exclusive.
